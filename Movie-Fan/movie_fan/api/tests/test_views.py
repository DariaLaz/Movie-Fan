...
class TestViews(TestCase):
    def setUp(self):
        ...
        Game.objects.create(
            name='Game1', description='Game1 description', host='host1', code='code1')
        Category.objects.create(
            name='Category1', description='Category1 description', game_id='1')
        ...
        # not in the game
        Player.objects.create(name='player1', user_id='1',
                              score=PlayerScore.objects.get(id=1))
        # in the game but hasnt submitted
        Player.objects.create(name='player2', user_id='2',
                              score=PlayerScore.objects.get(id=2))
        # in the game and submitted
        Player.objects.create(name='player3', user_id='3',
                              score=PlayerScore.objects.get(id=3))
        ...
        Submition.objects.create(movie=Movie.objects.get(id=1), category=Category.objects.get(
            id=1), points=10, player=Player.objects.get(id=3))
